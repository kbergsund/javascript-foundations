...
describe('Centaur', function() {
  ...
  it('should have a name', function() {
    var centaur1 = new Centaur({ name: 'Bad Daddy'});
    var centaur2 = new Centaur({ name: 'Bad Larry'});

    assert.equal(centaur1.name, 'Bad Daddy');
    assert.equal(centaur2.name, 'Bad Larry');
